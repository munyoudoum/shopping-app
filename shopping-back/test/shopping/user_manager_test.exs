defmodule Shopping.UserManagerTest do
  ...
  describe "users" do
    ...
    import Shopping.UserManagerFixtures

    @invalid_attrs %{balance: nil, username: nil, password: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{balance: "120.5", username: "some username", password: "some password"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{balance: "456.7", username: "updated username", password: "some updated password"}
